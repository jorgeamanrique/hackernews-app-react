...
const NewsCard = ({ article }) => {
    ...
    return (
        <div className="article-data">
            <a href={article.story_url} target="_blank" rel="noreferrer" >
                <div className='article-information'>
                    <span className="article-date-author">
                        ...
                        <div>{timeSince(new Date(article.created_at))} ago by {article.author}</div>
                    </span>
            ...
            <div className='fave'>
            {!liked ? 
                <svg className="image-fave" onClick={e => handleLiked(article.objectID)} xmlns="http://www.w3.org/2000/svg" width="24" height="22" viewBox="0 0 24 22">
